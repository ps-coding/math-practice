  ...
  return `${$$result.head += `<!-- HEAD_svelte-4mnmgn_START -->${$$result.title = `<title>Math Practice - About</title>`, ""}<meta name="description" content="Learn about all of the features of the website, Math Practice, and learn how to access it on Github. Website description: Practice your math skills with this simple game. You can practice addition, subtraction, multiplication, division, exponentiation, and roots. The game tracks your high score locally, uses coins as an in-game currency to buy additional time on a problem, has various cool and strategic powerups, and dynamically increases the difficulty of problems at different paces for different types of questions."><meta name="keywords" content="about information how to use math practice trainer game powerups addition sum subtraction difference multiplication product division quotient root roots exponents exponentiation dynamic difficulty coins currency high score"><!-- HEAD_svelte-4mnmgn_END -->`, ""} <h1 id="math-practice" data-svelte-h="svelte-1onr6t8">About <a href="/">Math Practice</a></h1> <summary data-svelte-h="svelte-1bk94jl">Contents:
	<ul><li><a href="#how-to-use">How to use</a>:
		...
		<ul><li>2 coins: 3 seconds of extra time on the current question (default time 10 sec per question)</li> <li>10 coins: Increment (by +2 sec) the amount of extra time granted after each answered
				...
				<br> <small><i>Note: The reason why it is required to give up gems for this is to prevent people who
						...
						help you reach higher levels much more easily and make up for the cost.</i></small></li></ul></li></ul> <h2 id="how-to-run-dev" data-svelte-h="svelte-10rzmrw">How to run (dev)</h2> <p data-svelte-h="svelte-49kxa5">Feel free to play around with/contribute to this project if you wish, although if you publish a
	fork, please give credit.</p> <ul data-svelte-h="svelte-rk4s52"><li>Make sure you have <a href="https://nodejs.org/en/" target="_blank">⧉ node</a> and npm</li> <li>Clone the repo <a href="https://github.com/ps-coding/math-practice" target="_blank">⧉ here</a></li> <li>Run <code>npm install</code> to get the dependencies</li> <li>Execute <code>npm run dev</code> in the terminal</li> <li>Open your browser to the localhost address displayed</li> <li>Enjoy!</li></ul> <i data-svelte-h="svelte-sf1obk">Some stylistic inspiration (mainly just regarding the text field input) was taken from <a href="https://mathtrainer.ai">⧉ Math Trainer Mental Math Competition</a>, but no code was copied. The current and future state of the project is and will be solely based
	on my ideas, and I am the only developer. I created the project because I felt like such a math
	app turned into a game would be useful and enjoyable.</i> <small data-svelte-h="svelte-st96g"><b>Access my personal website <a href="https://shahprasham.com">⧉ here</a>.</b></small>`;
});
export {
  Page as default
};
